...
public class NT_AssignmentRhs extends Absy implements NT_ReferenceRhs {

	/* constructor */
	public NT_AssignmentRhs() {
		super();
	}

	public String toString() {
		return "NT_AssignmentRhs";
	}
...
public String getAbsyName() { return "NT_AssignmentRhs";}
