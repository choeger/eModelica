...
public class NT_ModAssExpression extends Absy implements NT_Modification {

	/* constructor */
	public NT_ModAssExpression() {
		super();
	}

	public String toString() {
		return "NT_ModAssExpression";
	}
...
public String getAbsyName() { return "NT_ModAssExpression";}
