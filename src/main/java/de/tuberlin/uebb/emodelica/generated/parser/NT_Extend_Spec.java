...
public class NT_Extend_Spec extends Absy implements NT_Specifier {

	/* constructor */
	public NT_Extend_Spec() {
		super();
	}

	public String toString() {
		return "NT_Extend_Spec";
	}
...
public String getAbsyName() { return "NT_Extend_Spec";}
