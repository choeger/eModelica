...
public class NT_While_Statement extends Absy implements NT_StatementContent {

	/* constructor */
	public NT_While_Statement() {
		super();
	}

	public String toString() {
		return "NT_While_Statement";
	}
...
public String getAbsyName() { return "NT_While_Statement";}
