...
public class NT_FunctionCallReferencePart extends Absy {

	/* constructor */
	public NT_FunctionCallReferencePart() {
		super();
	}
...
public String getAbsyName() { return "NT_FunctionCallReferencePart";}
