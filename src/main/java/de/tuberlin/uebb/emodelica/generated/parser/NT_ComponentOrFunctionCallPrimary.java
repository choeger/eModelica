...
public class NT_ComponentOrFunctionCallPrimary extends Absy implements NT_Primary {

	/* constructor */
	public NT_ComponentOrFunctionCallPrimary() {
		super();
	}

	public String toString() {
		return "NT_ComponentOrFunctionCallPrimary";
	}
...
public String getAbsyName() { return "NT_ComponentOrFunctionCallPrimary";}
