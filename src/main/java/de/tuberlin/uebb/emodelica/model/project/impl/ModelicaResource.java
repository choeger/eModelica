 ...
 * 
 */
public abstract class ModelicaResource extends PlatformObject implements
		IModelicaResource {
	 ...
	 * 
	 * @see
	 * de.tuberlin.uebb.emodelica.model.project.IModelicaResource#registerListener
	 * (de.tuberlin.uebb.emodelica.model.IModelChangedListener)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.tuberlin.uebb.emodelica.model.project.IModelicaResource#removeListener
	 * (de.tuberlin.uebb.emodelica.model.IModelChangedListener)
	 */
	@Override
	 ...
	 * {@link IModelicaResourceChangedListener#resourceChanged
	...
	public void refresh() {
		synchronized (this) {
			if (dirty) {
				...
				System.err.println("[RESOURCE_REFRESH] " + " refreshing: "
						+ this);
				doRefresh();
				notifyListeners();
				syncChildren();
	 ...
	 * 
	 * @see
	 * de.tuberlin.uebb.emodelica.model.project.IModelicaResource#setResource
