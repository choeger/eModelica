 ...
 *
 */
public class DOMModel extends DOMSpecifier {

	public DOMModel(Model parentModel, NT_Specifier specifier, DOMNode parent) {
		super(parentModel,specifier,parent);
		setImageDescriptor(Images.MODEL_IMAGE_DESCRIPTOR);
	}
