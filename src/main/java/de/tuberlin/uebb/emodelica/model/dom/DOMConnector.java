 ...
 *
 */
public class DOMConnector extends DOMSpecifier {

	public DOMConnector(Model parentModel, NT_Specifier specifier, DOMNode parent) {
		super(parentModel,specifier,parent);
		setImageDescriptor(Images.PLUGIN_IMAGE_DESCRIPTOR);
	}
