...
public class PartialNameCompletionProposal extends AbstractModelicaCompletionProposal implements ICompletionProposal,
	...
	private final IModelicaPackage value;
	private final StyledString styledString;
	private IContextInformation contextInformation;

	public PartialNameCompletionProposal(int offset, int length,
			IModelicaPackage value) {
		super();
		this.length = length;
		this.offset = offset;
		this.value = value;
	...
	private StyledString createStyledString() {
		...
		styledString.append(value.getFullName());
	...
	public void apply(IDocument document) {
		try {
			document.replace(offset, length, value.getFullName());
